...
export const ProductCard = ({ product, index = 0 }: ProductCardProps) => {
  ...
  return (
    <Card
      className={`relative overflow-hidden gradient-card border-border hover-lift animate-slide-up group flex flex-col min-h-[430px]`}
    ...
    >
      ...
      {product.promotion && (
        <div className="absolute top-0 left-0 z-10">
          <Badge
            variant="outline"
            className="rounded-br-lg rounded-tl-lg bg-orange-100 text-orange-700 border-orange-300"
          >
            Promotion
          </Badge>
        </div>
      ...
      <div className="relative h-48 overflow-hidden">
        <img
          ...
          onError={(e) => {
            e.currentTarget.src =
              'https://images.pexels.com/photos/1591062/pexels-photo-1591062.jpeg?auto=compress&cs=tinysrgb&w=400';
          }}
        />
      ...
      {/* Content - flex pushes button to bottom */}
      <CardContent className="flex flex-col h-full pt-0">
        ...
        <div className="mt-auto">
          <Button
            ...
            asChild
          >
            <Link to={`/product/${product._id}`}>Voir les abonnements</Link>
          </Button>
        </div>
      </CardContent>
    </Card>
